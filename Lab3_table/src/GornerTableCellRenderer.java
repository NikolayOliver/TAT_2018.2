...
public class GornerTableCellRenderer implements TableCellRenderer {
    ...
    public GornerTableCellRenderer() {
       // Показатель только 5 знаков после запятой
        ...
        // Установить в качестве разделителя дробиной части точку, а не
        // запятую. По умолчанию, а региональных настройках
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int col){
        ...
        if (col==1 && needle!=null && needle.equals(formattedDouble)){
            ...
            // окрасить задний фот панели в красный цвет
            panel.setBackground(Color.RED);
        } else {
            // Иначе - в обычные белый
